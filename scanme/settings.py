...
SOCIAL_AUTH_VK_OAUTH2_SCOPE = ['offline', 'wall']

SOCIAL_AUTH_ODNOKLASSNIKI_OAUTH2_KEY = '1247766528'
SOCIAL_AUTH_ODNOKLASSNIKI_OAUTH2_SECRET = '6DCFAC9A5B92B2A71717BCCA'
SOCIAL_AUTH_ODNOKLASSNIKI_OAUTH2_PUBLIC_NAME = 'CBAJGQFLEBABABABA'
SOCIAL_AUTH_ODNOKLASSNIKI_OAUTH2_SCOPE = ['VALUABLE_ACCESS']

# SOCIAL_AUTH_ODNOKLASSNIKI_APP_KEY = '1247766528'
# SOCIAL_AUTH_ODNOKLASSNIKI_APP_SECRET = 'CBAJGQFLEBABABABA'
# SOCIAL_AUTH_ODNOKLASSNIKI_APP_PUBLIC_NAME = '6DCFAC9A5B92B2A71717BCCA'
